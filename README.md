...
- Tap `HOLD` with mobile units selected to make them guard their current positions and return if pulled too far away; when a selected Carrier holds, nearby friendly operational Helicopters/Fighters are also assigned to hold as its guard wing.
