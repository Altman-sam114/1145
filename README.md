...
- Mission objective panel with automatic stage completion: secure oil, capture front-line flags, secure two operational coastal assets for a one-time resource reward, deploy mixed land/air/naval forces, break enemy production, then destroy the Red HQ.
