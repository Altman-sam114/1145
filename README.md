...
- Mission objective panel with automatic stage completion: secure oil, capture front-line flags, secure two operational coastal assets and deploy mixed land/air/naval forces for one-time resource rewards, break enemy production, then destroy the Red HQ.
