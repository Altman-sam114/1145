...
- Mission objective panel with automatic stage completion: secure oil, capture front-line flags, secure two operational coastal assets, deploy mixed land/air/naval forces, and break enemy production for one-time resource rewards, then destroy the Red HQ.
