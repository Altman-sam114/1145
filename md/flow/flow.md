...
- AI 会赚钱、补生产建筑、Radar Outpost、Guard Tower、SAM Site 和 Coastal Battery、生产混合陆海空单位、占油/旗、重建、使用支援技能、基地被打时拉防守单位。
