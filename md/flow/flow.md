...
单位和建筑的静态定义来源：名称、短码、域、成本、建造时间、HP、速度、射程、伤害、冷却、视野、占地、生产来源、可生产项、可攻击目标。当前建筑包含 HQ、War Factory、Airfield、Radar Outpost、Guard Tower、Coastal Battery、Shipyard 和 Oil Derrick；Radar Outpost 是普通陆地结构，完工后提供较大静态视野并可作为 `SCAN` 资产；Guard Tower 是普通陆地防御结构，完工后自动攻击可见 land / air / structure 目标，不攻击 naval / submarine，也不提供声呐；Coastal Battery 是海岸防御结构，完工后只攻击可见水面海军目标，不攻击潜艇，也不提供声呐。
...
- HQ、已占领油井、已占领旗点提供收入。
- 建筑覆盖由己方已完工结构和己方已占领旗点提供；旗点覆盖范围小于结构覆盖范围。玩家建造仍需要目标位置可见，Shipyard 和 Coastal Battery 仍需要海岸，Oil Derrick 仍需要油田，建筑不能压住旗点中心。
...
- AI 会赚钱、补生产建筑、Radar Outpost、Guard Tower 和 Coastal Battery、生产混合陆海空单位、占油/旗、重建、使用支援技能、基地被打时拉防守单位。
...
- 建筑科技层：科技中心、防御塔、SAM、岸防炮平衡 / 升级、升级解锁和 Radar Outpost 后续平衡。
