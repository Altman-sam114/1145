...
- Battleship、Coastal Battery 或 Artillery 通过同一 `fire(...)` 链路命中玩家水面舰艇或玩家已知敌方水面舰艇时，会在目标偏侧显示短暂椭圆冲击圈、窄水柱、冠状泡沫和少量碎滴；隐藏敌舰不显示，Submarine 继续只走既有 ASW 反馈，效果不改变伤害、目标、迷雾或暴露。
