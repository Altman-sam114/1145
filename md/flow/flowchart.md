...
flowchart TD
  ...
  Loop --> Combat["战斗 / 维修\n未完工攻击结构禁火、SAM/AA 防空与选中空军已知覆盖威胁圈/顶标/摘要、岸防反舰、目标搜索、Carrier guard wing近域威胁优先、有效伤害、Artillery已知炮位炮口焰/烟尘/炮线、空战导弹烟迹/弹体/命中环、航母 wing strike、可见水面舰炮命中水柱、已知潜艇 direct-fire ASW HIT、支援命中潜艇短暴露、击杀 XP、老兵徽章、死亡清理"]
  ...
  Build --> Render["SpriteKit 渲染\n浅滩/岸线浪花、Humvee四轮/风挡/枪座、Tank与Artillery履带/炮塔/炮座/光学件、HEL/JET细化模型与投影、实体节点、特效、进度条"]
  Economy --> Render
  Commands --> Render
  Combat --> Render
  AI --> Render
