...
flowchart TD
  ...
  Loop --> Commands["移动 / 命令\n普通移动、海军方向航迹、HOLD、Carrier guard wing最多2架anchor station/分配组成cue/脱离反馈、AMOV、已知HQ指引和面板摘要、路径和编队"]
  Loop --> Combat["战斗 / 维修\n未完工攻击结构禁火、SAM/AA 防空、岸防反舰、目标搜索、Carrier guard wing近域威胁优先、有效伤害、航母 wing strike、可见水面舰炮命中水柱、已知潜艇 direct-fire ASW HIT、支援命中潜艇短暴露、击杀 XP、老兵徽章、死亡清理"]
